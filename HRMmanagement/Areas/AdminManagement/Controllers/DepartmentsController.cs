...
namespace HRMmanagement.Areas.AdminManagement.Controllers
{
    ...
    public class DepartmentsController : Controller
    {
        ...
        // GET: AdminManagement/Departments
        public async Task<IActionResult> Index()
        {
            return View(await _context.Departments.ToListAsync());
        }

        // GET: AdminManagement/Departments/Details/5
        ...
        // GET: AdminManagement/Departments/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: AdminManagement/Departments/Create
        ...
        // GET: AdminManagement/Departments/Edit/5
        ...
        // POST: AdminManagement/Departments/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: AdminManagement/Departments/Delete/5
        ...
        // POST: AdminManagement/Departments/Delete/5
