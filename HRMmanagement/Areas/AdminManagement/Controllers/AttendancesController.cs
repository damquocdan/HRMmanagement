...
namespace HRMmanagement.Areas.AdminManagement.Controllers
{
    ...
    public class AttendancesController : Controller
    {
        ...
        // GET: AdminManagement/Attendances/Create
        ...
        // POST: AdminManagement/Attendances/Create
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Create([Bind("AttendanceId,EmployeeId,AttendanceDate,CheckInTime,CheckOutTime,OvertimeHours,Status,CreatedAt")] Attendance attendance)
        {
        ...
        // GET: AdminManagement/Attendances/Edit/5
        ...
        // POST: AdminManagement/Attendances/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AttendanceId,EmployeeId,AttendanceDate,CheckInTime,CheckOutTime,OvertimeHours,Status,CreatedAt")] Attendance attendance)
        {
